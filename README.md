"Login Page" 
A Simple Page made using html,css and javascript for RBAC (Role based access authorization) and authentication practice and implemention 


Uses PHP with built-in MySQL setup usimg XAMPP ,as the database.

Functions:
1.Allows a person to Login to their existing account by entering email and password.

2.Navigated to Admin or User page depending on their role.
